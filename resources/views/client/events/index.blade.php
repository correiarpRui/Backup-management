                ...
                <tr class="font-semibold text-bblue border-b-2 border-bblue">
                    <td class="p-2">
                        <div class="flex items-center ">
                            ...
                            <a
                                href="{{ route('client.events', ['clientId' => $client->id, 'sort' => $sort === 'asc' ? 'desc' : 'asc', 'field' => 'name']) }}">
                                @if ($field != 'name')
                    ...
                    <td class="p-2">
                        <div class="flex items-center ">
                            ...
                            <a
                                href="{{ route('client.events', ['clientId' => $client->id, 'sort' => $sort === 'asc' ? 'desc' : 'asc', 'field' => 'operation_name']) }}">
                    ...
                    <td class="p-2">
                        <div class="flex items-center ">
                            ...
                            <a
                                href="{{ route('client.events', ['clientId' => $client->id, 'sort' => $sort === 'asc' ? 'desc' : 'asc', 'field' => 'begin_time']) }}">
                                @if ($field != 'begin_time')
                                    <svg xmlns="http://www.w3.org/2000/svg" width="0.63em" height="0.8em"
                                        viewBox="0 0 320 512">
                                        <path fill="currentColor"
                    ...
                    <td class="p-2">
                        <div class="flex items-center ">
                            <p class="mr-1">End</p>
                            <a
                                href="{{ route('client.events', ['clientId' => $client->id, 'sort' => $sort === 'asc' ? 'desc' : 'asc', 'field' => 'end_time']) }}">
                                @if ($field != 'end_time')
                                    <svg xmlns="http://www.w3.org/2000/svg" width="0.63em" height="0.8em"
                                        viewBox="0 0 320 512">
                                        <path fill="currentColor"
                    ...
                    <td class="p-2">
                        <div class="flex items-center ">
                            ...
                            <a
                                href="{{ route('client.events', ['clientId' => $client->id, 'sort' => $sort === 'asc' ? 'desc' : 'asc', 'field' => 'duration']) }}">
                                @if ($field != 'duration')
                                    <svg xmlns="http://www.w3.org/2000/svg" width="0.63em" height="0.8em"
                                        viewBox="0 0 320 512">
                                        <path fill="currentColor"
                    ...
                    <td class="p-2">
                        <div class="flex items-center ">
                            ...
                            <a
                                href="{{ route('client.events', ['clientId' => $client->id, 'sort' => $sort === 'asc' ? 'desc' : 'asc', 'field' => 'warnings']) }}">
                                @if ($field != 'warnings')
                                    <svg xmlns="http://www.w3.org/2000/svg" width="0.63em" height="0.8em"
                                        viewBox="0 0 320 512">
                                        <path fill="currentColor"
                    ...
                    <td class="p-2">
                        <div class="flex items-center ">
                            ...
                            <a
                                href="{{ route('client.events', ['clientId' => $client->id, 'sort' => $sort === 'asc' ? 'desc' : 'asc', 'field' => 'errors']) }}">
                                @if ($field != 'errors')
                                    <svg xmlns="http://www.w3.org/2000/svg" width="0.63em" height="0.8em"
                                        viewBox="0 0 320 512">
                                        <path fill="currentColor"
                    ...
                    @if (!empty($backup))
                        @foreach ($backup->reports as $event)
                            <tr class="even:bg-blgray">
                                ...
                                <td class="p-2">
                                    {{ round(\Carbon\Carbon::parse($event->duration)->secondsSinceMidnight()) }}
                                    seconds
                                </td>
